...
const Node = ({ icon: Icon, title, subtitle, x, y, glow }) => (
  <div
    className="absolute"
    style={{ transform: `translate(${x}px, ${y}px)` }}
  >
    <div className={`animated-border rounded-2xl p-[1px] ${glow ? 'shadow-[0_0_60px_-10px_rgba(168,85,247,0.5)]' : ''}`}>
      <div className="glass-card rounded-2xl px-4 py-3 min-w-[180px]">
    ...
    <section id="pricing" className="relative py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-3 text-slate-300/80">Visual, node-based flows inspired by the best of n8n and the polish of Webflow. Connect triggers, messages, actions and data with glowing, animated links.</p>
        </div>
        ...
        <div className="relative mt-14 rounded-3xl p-1 animated-border">
          <div className="relative rounded-3xl overflow-hidden glass-card">
            <div className="relative h-[520px]">
              ...
              {/* nodes */}
              <Node icon={Bot} title="Trigger" subtitle="Lead created" x={120} y={140} glow />
              <Node icon={MessageSquare} title="Chat" subtitle="Qualify lead" x={320} y={280} />
              <Node icon={Workflow} title="Decision" subtitle="Route intent" x={540} y={160} />
              <Node icon={PhoneCall} title="Call" subtitle="Warm transfer" x={720} y={280} />
              <Node icon={Database} title="CRM" subtitle="Create opportunity" x={980} y={340} />
