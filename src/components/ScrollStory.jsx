...
export default function ScrollStory() {
  ...
  const y1 = useTransform(scrollYProgress, [0, 1], [40, -160])
  ...
  return (
    <section id="workflows" ref={containerRef} className="relative py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map(({ icon: Icon, title, text }) => (
            <motion.div key={title} whileInView={{ y: [20, 0], opacity: [0, 1] }} viewport={{ once: true, amount: 0.5 }} transition={{ type: 'spring', stiffness: 60 }} className="neon-stroke rounded-2xl p-[1px] trace-border trace-animate">
